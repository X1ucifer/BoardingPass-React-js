...
function BoardingPass({ reference }) {
    return (
        <>
            <div ref={reference} >
                                    ...
                                    <div className=''>
                                        <div className='flex justify-between'>
                                            <div className='mt-[30px] ml-[40px]'>
                                                <h4>MATTA/MAYANK MR</h4>
                                            </div>

                                            <div className='mt-[30px] mr-[40px]'>
                                                <h4>DELHI(T1) To JAIPUR(T1)</h4>
                                            </div>
                                        </div>
                                        ...
                                        <div className='mt-[20px]  flex justify-evenly'>
                                            ...
                                            <div className='border-2 border-zinc-900  pl-[10px] pr-[10px]'>
                                                <p>Seat</p>
                                                <h2 className='font-bold'>15E</h2>
                                            </div>
                                        </div>

                                        <div className='flex justify-between'>
                                            <div className='mt-[50px] ml-[30px] mb-[40px]'>
                                                <QRCode value="https://reactjs.org/" size="140" renderAs="canvas" />
                                            </div>

                                            <div className='mt-[60px]'>
                                                <div className='flex justify-between'>
                                                    <p>Date - </p>
                                                    <p className='font-bold'>25 Mar 2022</p>
                                                </div>
                                ...
                                <div className=''>
                                    ...
                                    <div className='flex justify-between'>
                                        <div className='mt-[10px] ml-[20px] mb-[40px]'>
                                            <QRCode value="https://reactjs.org/" size="100" renderAs="canvas" />
                                        </div>
